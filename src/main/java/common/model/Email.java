...
public class Email {
    ...
    private String sendUserPass; // 发件人密码：smtp ssl登录授权码
     ...
     * @return
     */
    public boolean sendTo() throws Exception {
        ...
        // 发送邮件
        transport.sendMessage(mimeMsg, mimeMsg.getRecipients(Message.RecipientType.TO));//发送邮件给收件人
        transport.sendMessage(mimeMsg, mimeMsg.getRecipients(Message.RecipientType.CC));//发送邮件给抄送人
